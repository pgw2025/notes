        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagIdsSnapshot = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NoteVersions_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteVersions_CreatedByUserId",
                table: "NoteVersions",
